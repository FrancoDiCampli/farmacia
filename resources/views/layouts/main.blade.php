...
<body class="animsition">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="{{route('usuarios.index')}}">
                                <i class="fas fa-copy"></i>Usuarios</a>

                        </li>

                        <li class="has-sub">
                            <a class="js-arrow" href="{{route('productos.index')}}">
                                <i class="fas fa-copy"></i>Administrar Articulos</a>

                        </li>

                        <li class="has-sub">
                            <a class="js-arrow" href="{{route('inventarios.index')}}">
                                <i class="fas fa-copy"></i>Administrar Inventario</a>
    ...
    <!-- Vendor JS       -->
    <script src="{{asset('main/vendor/slick/slick.min.js')}}">
    </script>
    ...
    <script src="{{asset('main/vendor/counter-up/jquery.counterup.min.js')}}">
    </script>
    ...
    <script src="{{asset('main/vendor/select2/select2.min.js')}}">
    </script>
